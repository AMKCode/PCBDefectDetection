...
class CustomVGG16(nn.Module):
    def __init__(self, n_classes=2, pretrained=True):
        ...
        # convert to greyscale input
        # self.feature_extractor.conv1 = torch.nn.Conv2d(1, 64, kernel_size=7, stride=2, padding=3, bias=False, input_shape=(224, 224, 1))
        
        self.classification_head = nn.Linear(1000, n_classes) # since the number of output for VGG16 is 1000
...
#     def __init__(self, n_classes=2, pretrained=True):
#         super(CustomVGG16, self).__init__()
#         self.feature_extractor = models.vgg16(pretrained=pretrained).features[:1]
